...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (type === "setup") {
        const { TypiaSetupWizard } = yield Promise.resolve().then(() => __importStar(require("./TypiaSetupWizard.js")));
        yield TypiaSetupWizard.setup();
    }
    else if (type === "patch") {
        const { TypiaPatchWizard } = yield Promise.resolve().then(() => __importStar(require("./TypiaPatchWizard.js")));
        ...
        const { TypiaGenerateWizard } = yield Promise.resolve().then(() => __importStar(require("./TypiaGenerateWizard.js")));
