...
const JsonDescriptor_1 = require("./JsonDescriptor");
/** @internal */
...
(function (OpenApiTypeCheckerBase) {
    ...
    OpenApiTypeCheckerBase.isRecursiveReference = (props) => {
        ...
        if (OpenApiTypeCheckerBase.isReference(props.schema) === false)
            return false;
        const current = (_a = props.schema.$ref.split(props.prefix)[1]) !== null && _a !== void 0 ? _a : props.schema.$ref.split("/").at(-1);
        let counter = 0;
        OpenApiTypeCheckerBase.visit({
            ...
            closure: (schema) => {
                ...
                if (OpenApiTypeCheckerBase.isReference(schema)) {
                    const next = (_a = schema.$ref.split(props.prefix)[1]) !== null && _a !== void 0 ? _a : schema.$ref.split("/").at(-1);
                    if (current === next)
                        ++counter;
                }
            },
    ...
    OpenApiTypeCheckerBase.escape = (props) => {
        var _a, _b;
        const reasons = [];
        const result = escapeSchema(Object.assign(Object.assign({}, props), { reasons, visited: new Map(), accessor: (_a = props.accessor) !== null && _a !== void 0 ? _a : "$input.schema", refAccessor: (_b = props.refAccessor) !== null && _b !== void 0 ? _b : getReference(props.prefix) })) || null;
        if (result === null)
            return {
                success: false,
                error: {
    ...
    OpenApiTypeCheckerBase.visit = (props) => {
        ...
        const refAccessor = (_a = props.refAccessor) !== null && _a !== void 0 ? _a : `$input.${getReference(props.prefix)}`;
    ...
    const escapeSchema = (props) => {
        ...
        if (OpenApiTypeCheckerBase.isReference(props.schema)) {
            // REFERENCE
            const key = (_a = props.schema.$ref.split(props.prefix)[1]) !== null && _a !== void 0 ? _a : props.schema.$ref.split("/").at(-1);
            ...
            if (target === undefined) {
                ...
                return res
                    ? Object.assign(Object.assign({}, res), { description: JsonDescriptor_1.JsonDescriptor.cascade({
                            prefix: props.prefix,
                            components: props.components,
                            schema: props.schema,
                            escape: true,
            ...
            const properties = Object.entries((_c = object.properties) !== null && _c !== void 0 ? _c : {}).map(([k, s]) => [
                k,
            ...
            if (properties.some(([_k, v]) => v === null) ||
                ...
                return undefined;
            return Object.assign(Object.assign({}, object), { properties: Object.fromEntries(properties.filter(([_k, v]) => v !== undefined)), additionalProperties: additionalProperties !== null && additionalProperties !== void 0 ? additionalProperties : false, required: (_e = (_d = object.required) === null || _d === void 0 ? void 0 : _d.filter((k) => properties.some(([key, value]) => key === k && value !== undefined))) !== null && _e !== void 0 ? _e : [] });
        }
    ...
    const coverEscapedSchema = (p) => {
        ...
        // ATOMIC CASE
            ...
            return (OpenApiTypeCheckerBase.isInteger(p.y) || OpenApiTypeCheckerBase.isConstant(p.y)) && OpenApiTypeCheckerBase.coverInteger(p.x, p.y);
            ...
            return ((OpenApiTypeCheckerBase.isConstant(p.y) || OpenApiTypeCheckerBase.isInteger(p.y) || OpenApiTypeCheckerBase.isNumber(p.y)) &&
                OpenApiTypeCheckerBase.coverNumber(p.x, p.y));
        else if (OpenApiTypeCheckerBase.isString(p.x))
            return (OpenApiTypeCheckerBase.isConstant(p.y) || OpenApiTypeCheckerBase.isString(p.y)) && OpenApiTypeCheckerBase.coverString(p.x, p.y);
        // INSTANCE CASE
...
const getReference = (prefix) => prefix
    .split("/")
    .filter((str, i) => !!str.length && !(i === 0 && str === "#"))
    .join(".");
//# sourceMappingURL=OpenApiTypeCheckerBase.js.map