...
const metadata_to_pattern_1 = require("../iterate/metadata_to_pattern");
var CloneJoiner;
(function (CloneJoiner) {
    CloneJoiner.object = (props) => {
        ...
        const literal = typescript_1.default.factory.createObjectLiteralExpression(regular.map((entry) => {
            ...
            return typescript_1.default.factory.createPropertyAssignment(utils_1.NamingConvention.variable(str)
                ? str
