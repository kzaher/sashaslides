    ...
    UnionPredicator.object = (objects) => {
        ...
        for (const obj of objects)
            for (const prop of obj.properties) {
                ...
                if (key !== null)
                    utils_1.MapUtil.take(matrix, key, () => utils_1.ArrayUtil.repeat(objects.length, () => null));
            }
        ...
        objects.forEach((obj, i) => {
            ...
            obj.properties.forEach((prop) => {
                ...
                const unique = neighbors.length === 0 ||
                    neighbors.every((n) => !MetadataSchema_1.MetadataSchema.intersects(prop.value, n.value));
                if (unique === true)
                    children.push({
                        property: prop,
