...
const check_native_1 = require("../iterate/check_native");
const decode_union_object_1 = require("../iterate/decode_union_object");
const postfix_of_tuple_1 = require("../iterate/postfix_of_tuple");
const wrap_metadata_rest_tuple_1 = require("../iterate/wrap_metadata_rest_tuple");
...
(function (JsonStringifyProgrammer) {
    ...
    const decode = (props) => {
        ...
        if (props.metadata.templates.length)
            if (AtomicPredicator_1.AtomicPredicator.template(props.metadata)) {
                const partial = MetadataSchema_1.MetadataSchema.initialize();
    ...
    const decode_atomic = (props) => {
        if (props.type === "string")
            ...
            props = Object.assign(Object.assign({}, props), { input: props.validated && OptionPredicator_1.OptionPredicator.finite(props.context.options)
                    ? props.input
                    : typescript_1.default.factory.createCallExpression(props.context.importer.internal("jsonStringifyNumber"), undefined, [props.input]) });
        return typescript_1.default.factory.createCallExpression(typescript_1.default.factory.createIdentifier("String"), undefined, [props.input]);
    };
