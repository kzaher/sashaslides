...
(function (JsonStringifyProgrammer) {
    ...
    const decode_atomic = (props) => {
        if (props.type === "string")
            ...
            props = {
                ...props,
                input: props.validated && OptionPredicator.finite(props.context.options)
                    ? props.input
                    : ts.factory.createCallExpression(props.context.importer.internal("jsonStringifyNumber"), undefined, [props.input]),
            };
        return ts.factory.createCallExpression(ts.factory.createIdentifier("String"), undefined, [props.input]);
    };
