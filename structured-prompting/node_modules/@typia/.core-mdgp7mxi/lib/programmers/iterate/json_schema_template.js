    ...
    if (pureTemplates.length)
        output.push({
            ...
            pattern: (0, metadata_to_pattern_1.metadata_to_pattern)({
                top: true,
                metadata: MetadataSchema_1.MetadataSchema.create(Object.assign(Object.assign({}, MetadataSchema_1.MetadataSchema.initialize()), { templates: pureTemplates })),
            }),
        });
    for (const tpl of taggedTemplates)
        output.push(...(0, json_schema_plugin_1.json_schema_plugin)({
            schema: {
                ...
                pattern: (0, metadata_to_pattern_1.metadata_to_pattern)({
                    top: false,
                    metadata: MetadataSchema_1.MetadataSchema.create(Object.assign(Object.assign({}, MetadataSchema_1.MetadataSchema.initialize()), { templates: [tpl] })),
                }),
            },
