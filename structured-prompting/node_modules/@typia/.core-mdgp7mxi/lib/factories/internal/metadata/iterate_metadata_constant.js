...
const iterate_metadata_constant = (props) => {
    ...
    if (props.type.isLiteral()) {
        const value = typeof props.type.value === "object"
            ...
            : props.type.value;
        const constant = utils_1.ArrayUtil.take(props.metadata.constants, (elem) => elem.type === typeof value, () => MetadataConstant_1.MetadataConstant.create({
            type: typeof value,
            values: [],
        }));
        utils_1.ArrayUtil.add(constant.values, MetadataConstantValue_1.MetadataConstantValue.create(Object.assign({ value, tags: [] }, comment())), (a, b) => a.value === b.value);
        return true;
    }
    else if (filter(typescript_1.default.TypeFlags.BooleanLiteral)) {
        const value = props.checker.typeToString(props.type) === "true";
        const constant = utils_1.ArrayUtil.take(props.metadata.constants, (elem) => elem.type === "boolean", () => MetadataConstant_1.MetadataConstant.create({
            type: "boolean",
            values: [],
        }));
        utils_1.ArrayUtil.add(constant.values, MetadataConstantValue_1.MetadataConstantValue.create(Object.assign({ value, tags: [] }, comment())), (a, b) => a.value === b.value);
