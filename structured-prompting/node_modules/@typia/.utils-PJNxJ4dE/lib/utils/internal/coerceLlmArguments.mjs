    ...
    if (LlmTypeChecker.isAnyOf(schema)) {
        ...
        if (typeof value === "string") {
            ...
            if (value.length === 1 && value.toLowerCase() === "n") {
                const hasBoolean = schema.anyOf.some((s) => LlmTypeChecker.isBoolean(resolveSchema(s, $defs)));
                const hasNull = schema.anyOf.some((s) => LlmTypeChecker.isNull(resolveSchema(s, $defs)));
