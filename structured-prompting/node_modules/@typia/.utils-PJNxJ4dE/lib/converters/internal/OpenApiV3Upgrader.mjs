...
import { OpenApiV3TypeChecker } from '../../validators/OpenApiV3TypeChecker.mjs';
    ...
    OpenApiV3Upgrader.convertSchema = (components) => (input) => {
        ...
        const visit = (schema) => {
            ...
            if (Array.isArray(schema.enum) &&
                ...
                nullable.value ||= true;
            // UNION TYPE CASE
            if (OpenApiV3TypeChecker.isAnyOf(schema))
            ...
            // ATOMIC TYPE CASE (CONSIDER ENUM VALUES)
            else if (OpenApiV3TypeChecker.isBoolean(schema) ||
                ...
                else if (OpenApiV3TypeChecker.isInteger(schema) ||
                    OpenApiV3TypeChecker.isNumber(schema))
            ...
            else if (OpenApiV3TypeChecker.isReference(schema))
                union.push(schema);
            else
                union.push(schema);
        };
