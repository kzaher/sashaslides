import { OpenApiTypeChecker, LlmSchemaConverter } from '@typia/utils';
...
(function (LlmParametersProgrammer) {
    LlmParametersProgrammer.write = (props) => {
        ...
        return ts.factory.createAsExpression(ts.factory.createSatisfiesExpression(LiteralFactory.write(schema), typeNode), typeNode);
    };
    LlmParametersProgrammer.writeParameters = (props) => {
