...
const json_schema_jsDocTags_1 = require("./json_schema_jsDocTags");
...
const create_object_schema = (props) => {
    ...
    for (const property of props.object.type.properties) {
        ...
        const value = (0, json_schema_station_1.json_schema_station)({
            blockNever: true,
        ...
        if (value === null)
            ...
            (0, json_schema_jsDocTags_1.json_schema_jsDocTags)(value, property.jsDocTags);
        ...
        if (key !== null) {
            ...
            if (pattern === PatternUtil_1.PatternUtil.STRING)
                ...
                extraMeta.patternProperties[pattern] = [property.value, value];
        }
    }
    return (0, json_schema_jsDocTags_1.json_schema_jsDocTags)({
        type: "object",
        properties,
        required,
        title: (() => {
...
const join = (props) => {
    ...
    const metadata = elements
        .map((tuple) => tuple[0])
        .reduce((x, y) => MetadataSchema_1.MetadataSchema.merge(x, y));
