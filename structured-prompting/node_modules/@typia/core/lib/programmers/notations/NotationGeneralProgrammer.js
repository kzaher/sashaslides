...
(function (NotationGeneralProgrammer) {
    NotationGeneralProgrammer.returnType = (props) => props.context.importer.type({
        file: "typia",
        name: `${utils_1.NamingConvention.capitalize(props.rename.name)}Case`,
    ...
    const decode = (props) => {
        ...
        if (props.metadata.any ||
            ...
            return ExpressionFactory_1.ExpressionFactory.currying({
                ...
                arguments: [
                    props.context.importer.internal(`notation${utils_1.NamingConvention.capitalize(props.rename.name)}`),
                    props.input,
                ],
            });
        const unions = [];
