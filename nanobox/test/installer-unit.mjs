...
if (!codexArgs.includes('cli_auth_credentials_store="file"') || !codexArgs.includes('model_provider="nanobox-https"') || !codexArgs.includes('model_providers.nanobox-https.base_url="https://chatgpt.com/backend-api/codex"') || !codexArgs.includes("model_providers.nanobox-https.supports_websockets=false") || !codexArgs.includes('model_providers.nanobox-https.wire_api="responses"')) throw new Error("Codex must use durable file auth and the authenticated HTTPS-only Codex Responses provider");
...
if (clis.includes("codex")) must.push(["usr/local/bin/codex", "l", "../lib/node_modules/@openai/codex/bin/codex.js"], ["usr/local/lib/node_modules/@openai/codex/bin/codex.js", "f", 0o755], ["usr/local/lib/node_modules/@openai/codex/node_modules/@openai/codex-linux-x64/vendor/x86_64-unknown-linux-musl/bin/codex", "f", 0o755], ["usr/local/lib/node_modules/@openai/codex/node_modules/@openai/codex-linux-x64/vendor/x86_64-unknown-linux-musl/bin/codex-code-mode-host", "f", 0o755], ["usr/local/lib/node_modules/@openai/codex/node_modules/@openai/codex-linux-x64/vendor/x86_64-unknown-linux-musl/codex-resources/bwrap", "f", 0o755], ["usr/local/lib/node_modules/@openai/codex/node_modules/@openai/codex-linux-x64/package.json", "f"], ["usr/local/bin/codex-code-mode-host", "l", "../lib/node_modules/@openai/codex/node_modules/@openai/codex-linux-x64/vendor/x86_64-unknown-linux-musl/bin/codex-code-mode-host"], ["usr/local/bin/bwrap", "l", "../lib/node_modules/@openai/codex/node_modules/@openai/codex-linux-x64/vendor/x86_64-unknown-linux-musl/codex-resources/bwrap"], ["usr/local/bin/codex-linux-x64", null]);
