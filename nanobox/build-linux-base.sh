...
# must match web/native/installer.js PERSIST_ROOTS. `$bunfs` is claude-native's: the Bun standalone
# bundle opens its assets (mermaid, hljs, the html template) by their literal /$bunfs/root/… paths
PERSIST='usr/local,root,home,var,$bunfs'
