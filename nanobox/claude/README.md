# nanobox/claude — a faster x86-64 browser VM, byte-identical to the Bochs engine

Claude's track for `nanobox/TASK.md`. Everything lives in this directory (sources, scripts,
harness, the final web page). Big build trees / toolchains / wasm outputs are gitignored and are
reproduced by the scripts below.
