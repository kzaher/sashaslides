#!/usr/bin/env node
// Static server for nanobox/claude's browser artifact.
//
...
createServer(async (req, res) => {
  ...
  console.log(`nanobox/claude: http://localhost:${PORT}/  (optimized engine: ${ENGINE}${existsSync(ENGINE) ? "" : "  <-- MISSING"}; JIT bundles: ${JITDIR})`);
});
