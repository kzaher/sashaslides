...
exports.OpenApiV3_1Upgrader = void 0;
const OpenApiTypeChecker_1 = require("../../validators/OpenApiTypeChecker");
const OpenApiV3_1TypeChecker_1 = require("../../validators/OpenApiV3_1TypeChecker");
const OpenApiExclusiveEmender_1 = require("./OpenApiExclusiveEmender");
var OpenApiV3_1Upgrader;
(function (OpenApiV3_1Upgrader) {
    OpenApiV3_1Upgrader.convert = (input) => {
        var _a;
        if (input["x-typia-emended-v12"] === true)
            return input;
        return Object.assign(Object.assign({}, input), { openapi: "3.2.0", components: OpenApiV3_1Upgrader.convertComponents((_a = input.components) !== null && _a !== void 0 ? _a : {}), paths: input.paths
                ...
                : undefined, "x-typia-emended-v12": true });
    };
    /* -----------------------------------------------------------
      OPERATORS
    ----------------------------------------------------------- */
    const convertWebhooks = (doc) => (webhook) => {
        var _a, _b, _c;
        if (!OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isReference(webhook))
    ...
    const convertOperation = (doc) => (pathItem) => (input) => {
        ...
        return (Object.assign(Object.assign({}, input), { parameters: pathItem.parameters !== undefined || input.parameters !== undefined
                ? [...((_a = pathItem.parameters) !== null && _a !== void 0 ? _a : []), ...((_b = input.parameters) !== null && _b !== void 0 ? _b : [])]
                    ...
                    if (!OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isReference(p))
    ...
    const convertParameter = (components) => (input) => (Object.assign(Object.assign({}, input), { schema: OpenApiV3_1Upgrader.convertSchema(components)(input.schema), examples: input.examples
            ? Object.fromEntries(Object.entries(input.examples)
                .map(([key, value]) => {
                var _a, _b;
                return [
                    key,
                    OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isReference(value)
    ...
    const convertRequestBody = (doc) => (input) => {
        var _a, _b, _c, _d;
        if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isReference(input)) {
    ...
    const convertResponse = (doc) => (input) => {
        ...
        return Object.assign(Object.assign({}, input), { content: input.content
                ...
                ? Object.fromEntries(Object.entries(input.headers)
                    ...
                    (() => {
                        var _a, _b, _c, _d, _e;
                        if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isReference(value) === false)
    ...
    const convertContent = (components) => (record) => Object.fromEntries(Object.entries(record)
        ...
        Object.assign(Object.assign({}, value), { schema: value.schema
                ? OpenApiV3_1Upgrader.convertSchema(components)(value.schema)
    ...
    /* -----------------------------------------------------------
      DEFINITIONS
    ----------------------------------------------------------- */
    OpenApiV3_1Upgrader.convertComponents = (input) => {
        var _a;
        return ({
            schemas: Object.fromEntries(Object.entries((_a = input.schemas) !== null && _a !== void 0 ? _a : {})
                .filter(([_, v]) => v !== undefined)
                .map(([key, value]) => [key, OpenApiV3_1Upgrader.convertSchema(input)(value)])),
            securitySchemes: input.securitySchemes,
        });
    };
    OpenApiV3_1Upgrader.convertSchema = (components) => (input) => {
        const union = [];
        ...
        const visit = (schema) => {
            ...
            if (Array.isArray(schema.enum) &&
                ...
                nullable.value || (nullable.value = true);
            // MIXED TYPE CASE
            if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isMixed(schema)) {
            ...
            // UNION TYPE CASE
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isOneOf(schema))
                schema.oneOf.forEach(visit);
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isAnyOf(schema))
                schema.anyOf.forEach(visit);
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isAllOf(schema))
                if (schema.allOf.length === 1)
                    visit(schema.allOf[0]);
                else
                    union.push(convertAllOfSchema(components)(schema));
            // ATOMIC TYPE CASE (CONSIDER ENUM VALUES)
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isBoolean(schema))
            ...
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isInteger(schema) ||
                OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isNumber(schema))
            ...
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isString(schema))
            ...
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isArray(schema)) {
                if (Array.isArray(schema.items))
                    union.push(Object.assign(Object.assign({}, schema), {
                        items: undefined,
                        prefixItems: schema.items.map(OpenApiV3_1Upgrader.convertSchema(components)),
                        additionalItems: typeof schema.additionalItems === "object" &&
                            schema.additionalItems !== null
                            ? OpenApiV3_1Upgrader.convertSchema(components)(schema.additionalItems)
                            : schema.additionalItems,
                    }));
                else if (Array.isArray(schema.prefixItems))
                    union.push(Object.assign(Object.assign({}, schema), {
                        items: undefined,
                        prefixItems: schema.prefixItems.map(OpenApiV3_1Upgrader.convertSchema(components)),
                        additionalItems: typeof schema.additionalItems === "object" &&
                            schema.additionalItems !== null
                            ? OpenApiV3_1Upgrader.convertSchema(components)(schema.additionalItems)
                            : schema.additionalItems,
                    ...
                    union.push(Object.assign(Object.assign({}, schema), {
                        items: OpenApiV3_1Upgrader.convertSchema(components)(schema.items),
                        prefixItems: undefined,
                        additionalItems: undefined,
                    }));
            }
            // OBJECT TYPE CASE
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isObject(schema))
                union.push(Object.assign(Object.assign({}, schema), {
                    properties: schema.properties
                        ? Object.fromEntries(Object.entries(schema.properties)
                            .filter(([_, v]) => v !== undefined)
                            .map(([key, value]) => [key, OpenApiV3_1Upgrader.convertSchema(components)(value)]))
                        : {},
                    additionalProperties: schema.additionalProperties
                        ? typeof schema.additionalProperties === "object" &&
                            schema.additionalProperties !== null
                            ? OpenApiV3_1Upgrader.convertSchema(components)(schema.additionalProperties)
                            : schema.additionalProperties
                        : undefined,
                    required: (_l = schema.required) !== null && _l !== void 0 ? _l : [],
                }));
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isReference(schema))
                union.push(Object.assign(Object.assign({}, schema), {
                    $ref: `#/components/schemas/${schema.$ref.split("/").pop()}`,
                }));
            else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isRecursiveReference(schema))
                union.push(Object.assign(Object.assign({}, schema), {
    ...
    const retrieveObject = (components) => (input, visited = new Set()) => {
        ...
        if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isObject(input))
        ...
        else if (OpenApiV3_1TypeChecker_1.OpenApiV3_1TypeChecker.isRecursiveReference(input))
...
})(OpenApiV3_1Upgrader || (exports.OpenApiV3_1Upgrader = OpenApiV3_1Upgrader = {}));
//# sourceMappingURL=OpenApiV3_1Upgrader.js.map