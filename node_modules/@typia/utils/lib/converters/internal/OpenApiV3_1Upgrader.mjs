...
import { OpenApiV3_1TypeChecker } from '../../validators/OpenApiV3_1TypeChecker.mjs';
...
(function (OpenApiV3_1Upgrader) {
    OpenApiV3_1Upgrader.convert = (input) => {
        ...
        return {
            ...input,
            openapi: "3.2.0",
            components: OpenApiV3_1Upgrader.convertComponents(input.components ?? {}),
            paths: input.paths
    ...
    const convertOperation = (doc) => (pathItem) => (input) => ({
        ...input,
        parameters: pathItem.parameters !== undefined || input.parameters !== undefined
    ...
    const convertParameter = (components) => (input) => ({
        ...input,
        schema: OpenApiV3_1Upgrader.convertSchema(components)(input.schema),
                ...
                ? Object.fromEntries(Object.entries(input.headers)
                    ...
                    (() => {
                        ...
                        const found = value.$ref.startsWith("#/components/headers/")
                            ? doc.components?.headers?.[value.$ref.split("/").pop() ?? ""]
                            : undefined;
                        return found !== undefined
                            ? convertParameter(doc.components ?? {})({
                                ...found,
    ...
    OpenApiV3_1Upgrader.convertComponents = (input) => ({
        schemas: Object.fromEntries(Object.entries(input.schemas ?? {})
            .filter(([_, v]) => v !== undefined)
    ...
    OpenApiV3_1Upgrader.convertSchema = (components) => (input) => {
        ...
        const visit = (schema) => {
                ...
                for (const type of schema.type)
                    if (type === "boolean" || type === "number" || type === "string")
                        visit({
                            ...schema,
                            ...{
                                enum: schema.enum?.length && schema.enum.filter((e) => e !== null)
            ...
            // ATOMIC TYPE CASE (CONSIDER ENUM VALUES)
            ...
            else if (OpenApiV3_1TypeChecker.isInteger(schema) ||
                ...
                if (schema.enum?.length && schema.enum.filter((e) => e !== null))
                    ...
                    union.push(OpenApiExclusiveEmender.emend({
                        ...schema,
                        default: schema.default ?? undefined,
                        ...{
                            enum: undefined,
                        ...
                        exclusiveMaximum: typeof schema.exclusiveMaximum === "boolean"
    ...
    const convertAllOfSchema = (components) => (input) => {
        ...
        return {
            ...input,
            type: "object",
            properties: Object.fromEntries(objects
    ...
    const retrieveObject = (components) => (input, visited = new Set()) => {
        if (OpenApiV3_1TypeChecker.isObject(input))
            ...
            visited.add(input);
        if (OpenApiV3_1TypeChecker.isReference(input))
            return retrieveObject(components)(components.schemas?.[input.$ref.split("/").pop() ?? ""] ?? {}, visited);
        else if (OpenApiV3_1TypeChecker.isRecursiveReference(input))
            return retrieveObject(components)(components.schemas?.[input.$recursiveRef.split("/").pop() ?? ""] ??
                {}, visited);
        return null;
    };
})(OpenApiV3_1Upgrader || (OpenApiV3_1Upgrader = {}));

export { OpenApiV3_1Upgrader };
//# sourceMappingURL=OpenApiV3_1Upgrader.mjs.map
