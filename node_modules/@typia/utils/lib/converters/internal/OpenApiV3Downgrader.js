...
(function (OpenApiV3Downgrader) {
    ...
    const downgradeOperation = (collection) => (input) => (Object.assign(Object.assign({}, input), { parameters: input.parameters
            ...
            : undefined }));
    const downgradeParameter = (collection) => (input) => (Object.assign(Object.assign({}, input), { in: input.in === "querystring" ? "query" : input.in, schema: OpenApiV3Downgrader.downgradeSchema(collection)(input.schema) }));
...
//# sourceMappingURL=OpenApiV3Downgrader.js.map