...
(function (JsonDescriptor) {
    JsonDescriptor.cascade = (props) => {
        var _a, _b, _c;
        const accessors = ((_a = props.schema.$ref.split(props.prefix)[1]) !== null && _a !== void 0 ? _a : props.schema.$ref.split("/").at(-1)).split(".");
        ...
        if (!((_b = props.schema.description) === null || _b === void 0 ? void 0 : _b.length) && pReferences.length === 0)
            return undefined;
        return [
            ...(!!((_c = props.schema.description) === null || _c === void 0 ? void 0 : _c.length) ? [props.schema.description] : []),
    ...
    JsonDescriptor.take = (o) => {
        ...
        const result = [
            ...
            ...Object.entries((_b = o.properties) !== null && _b !== void 0 ? _b : {})
                ...
                .map(([key, value]) => {
                var _a;
                return `### Description of {@link ${NamingConvention_1.NamingConvention.variable(key) ? key : JSON.stringify(key)}} property:\n\n` +
...
})(JsonDescriptor || (exports.JsonDescriptor = JsonDescriptor = {}));
//# sourceMappingURL=JsonDescriptor.js.map