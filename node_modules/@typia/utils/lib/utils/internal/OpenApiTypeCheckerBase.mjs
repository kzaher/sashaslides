...
import { JsonDescriptor } from './JsonDescriptor.mjs';
...
(function (OpenApiTypeCheckerBase) {
    ...
    OpenApiTypeCheckerBase.visit = (props) => {
        ...
        const refAccessor = props.refAccessor ?? `$input.${getReference(props.prefix)}`;
    ...
    const escapeSchema = (props) => {
        if (OpenApiTypeCheckerBase.isReference(props.schema)) {
            ...
            const properties = Object.entries(object.properties ?? {}).map(([k, s]) => [
                k,
                escapeSchema({
                    ...props,
                    schema: s,
            ...
            if (properties.some(([_k, v]) => v === null) ||
                ...
                return null;
            else if (properties.some(([k, v]) => v === undefined && object.required?.includes(k) === true) === true)
                return undefined;
            return {
                ...object,
