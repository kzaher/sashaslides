import { LlmMetadataFactory, LlmCoerceProgrammer, MetadataFactory, MetadataCollection } from '@typia/core';
...
(function (LlmCoerceTransformer) {
    LlmCoerceTransformer.transform = (props) => {
            ...
            const result = MetadataFactory.analyze({
                ...
                options: {
                    ...
                    validate: validate === true
                        ? (next) => LlmCoerceProgrammer.validate({
                            config,
        ...
        analyze(true);
        // GENERATE CODE
        return ts.factory.createCallExpression(LlmCoerceProgrammer.write({
            context: props.context,
            modulo: props.modulo,
...
})(LlmCoerceTransformer || (LlmCoerceTransformer = {}));

export { LlmCoerceTransformer };
//# sourceMappingURL=LlmCoerceTransformer.mjs.map
