...
(function (ExpressionFactory) {
    ...
    ExpressionFactory.transpile = (props) => {
        const file = typescript_1.default.createSourceFile(`${_randomFormatUuid()}.ts`, props.script, typescript_1.default.ScriptTarget.ESNext, true, typescript_1.default.ScriptKind.TS);
