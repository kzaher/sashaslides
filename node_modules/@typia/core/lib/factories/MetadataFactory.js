...
(function (MetadataFactory) {
    ...
    MetadataFactory.soleLiteral = (value) => {
        const meta = MetadataSchema_1.MetadataSchema.initialize();
    ...
    const validateMeta = (props) => {
        ...
        result.push(...props.visitor.functor({
    ...
    const validateObject = (props) => {
        ...
        if (props.options.validate) {
            ...
            const errors = props.options.validate({
                metadata: MetadataSchema_1.MetadataSchema.create(Object.assign(Object.assign({}, MetadataSchema_1.MetadataSchema.initialize()), { objects: [
    ...
    const validateFunction = (props) => {
        ...
        for (const param of props.function.parameters)
            validateMeta(Object.assign(Object.assign({}, props), { metadata: param.type, explore: Object.assign(Object.assign({}, props.explore), { parameter: param.name, nested: null, top: false, output: false }), top: props.top }));
