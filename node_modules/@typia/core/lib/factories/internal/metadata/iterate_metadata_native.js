...
const iterate_metadata_native = (props) => {
    ...
    if (simple !== undefined &&
        ...
        utils_1.ArrayUtil.take(props.metadata.natives, (native) => native.name === name, () => MetadataNative_1.MetadataNative.create({
            name,
            tags: [],
        }));
        return true;
    ...
    for (const generic of GENERICS)
        if (name.substring(0, generic.name.length) === generic.name &&
            ...
            utils_1.ArrayUtil.take(props.metadata.natives, (native) => native.name === name, () => {
                var _a;
