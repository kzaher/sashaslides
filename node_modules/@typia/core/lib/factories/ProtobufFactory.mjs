...
(function (ProtobufFactory) {
    ...
    const validate = () => {
        ...
        return (props) => {
            ...
            // UNION IN ARRAY
            if (props.metadata.arrays.length &&
                props.metadata.arrays.some((a) => a.type.value.size() > 1 &&
            ...
            if (props.metadata.maps.length &&
                props.metadata.maps.some((m) => ProtobufUtil.getAtomics(m.key).size !== 1))
