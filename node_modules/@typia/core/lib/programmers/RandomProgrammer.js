...
const MetadataSchema_1 = require("../schemas/metadata/MetadataSchema");
...
const json_schema_array_1 = require("./iterate/json_schema_array");
const json_schema_bigint_1 = require("./iterate/json_schema_bigint");
const json_schema_boolean_1 = require("./iterate/json_schema_boolean");
const json_schema_number_1 = require("./iterate/json_schema_number");
const json_schema_string_1 = require("./iterate/json_schema_string");
/**
...
(function (RandomProgrammer) {
    ...
    const decode_atomic = (props) => {
        ...
        return schemaList.map((schema) => {
            const composed = (() => {
                if (props.atomic.type === "string") {
                    ...
                    if (string.format !== undefined) {
                        ...
                        return {
                            method: format
                                .split("-")
                                .map((s, i) => (i === 0 ? s : utils_1.NamingConvention.capitalize(s)))
                                .join(""),
                            internal: `randomFormat${format
                                .split("-")
                                .map(utils_1.NamingConvention.capitalize)
                                .join("")}`,
                            arguments: [],
                        };
                    }
                ...
                return {
                    method: props.atomic.type,
                    internal: `random${utils_1.NamingConvention.capitalize(props.atomic.type)}`,
                    arguments: [LiteralFactory_1.LiteralFactory.write(schema)],
                };
            })();
    ...
    const decode_map = (props) => typescript_1.default.factory.createNewExpression(typescript_1.default.factory.createIdentifier("Map"), undefined, [
        decode_array(Object.assign(Object.assign({}, props), { array: MetadataArray_1.MetadataArray.create({
                ...
                type: MetadataArrayType_1.MetadataArrayType.create({
                    ...
                    recursive: false,
                    nullables: [],
                    value: MetadataSchema_1.MetadataSchema.create(Object.assign(Object.assign({}, MetadataSchema_1.MetadataSchema.initialize()), { tuples: [
                            (() => {
    ...
    const decode_native_byte_array = (props) => {
        ...
        const atomic = props.name === "BigInt64Array" || props.name === "BigUint64Array"
            ? "bigint"
            : "number";
        const value = MetadataSchema_1.MetadataSchema.create(Object.assign(Object.assign({}, MetadataSchema_1.MetadataSchema.initialize()), { atomics: [
