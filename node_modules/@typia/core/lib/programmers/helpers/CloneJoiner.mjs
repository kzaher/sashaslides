...
import { metadata_to_pattern } from '../iterate/metadata_to_pattern.mjs';
...
(function (CloneJoiner) {
    CloneJoiner.object = (props) => {
        ...
        const literal = ts.factory.createObjectLiteralExpression(regular.map((entry) => {
            ...
            return ts.factory.createPropertyAssignment(NamingConvention.variable(str)
                ? str
    ...
    CloneJoiner.array = (props) => ts.factory.createCallExpression(ts.factory.createPropertyAccessExpression(props.input, "map"), undefined, [props.arrow]);
})(CloneJoiner || (CloneJoiner = {}));

export { CloneJoiner };
//# sourceMappingURL=CloneJoiner.mjs.map
