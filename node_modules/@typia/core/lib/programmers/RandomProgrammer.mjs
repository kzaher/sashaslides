...
import { json_schema_array } from './iterate/json_schema_array.mjs';
import { json_schema_bigint } from './iterate/json_schema_bigint.mjs';
import { json_schema_boolean } from './iterate/json_schema_boolean.mjs';
import { json_schema_number } from './iterate/json_schema_number.mjs';
import { json_schema_string } from './iterate/json_schema_string.mjs';
...
(function (RandomProgrammer) {
    ...
    const decode_native_byte_array = (props) => {
        ...
        const atomic = props.name === "BigInt64Array" || props.name === "BigUint64Array"
            ? "bigint"
            : "number";
        const value = MetadataSchema.create({
            ...MetadataSchema.initialize(),
            atomics: [
