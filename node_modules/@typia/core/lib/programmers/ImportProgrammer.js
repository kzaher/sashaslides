...
class ImportProgrammer {
    constructor(options) {
        ...
        this.options_ = {
            ...
            runtime: options === null || options === void 0 ? void 0 : options.runtime,
        };
    }
    /* -----------------------------------------------------------
      ENROLLMENTS
    ...
    instance(props) {
        ...
        const asset = this.take(props.file);
        utils_1.MapUtil.take(asset.instances, alias, () => props);
    ...
    getInternalText(name) {
        if (name.startsWith("_") === false)
            name = `_${name}`;
        const asset = this.take(`typia/lib/internal/${name}`);
    ...
    /** @internal */
    take(file) {
        return utils_1.MapUtil.take(this.assets_, file, () => ({
            file,
            default: null,
            namespace: null,
            instances: new Map(),
