...
async function main() {
  ...
  // Click "Got it" to dismiss the Office editing dialog
  ...
  // Now screenshot slides 1, 4, 8, 11, 15, 19
  for (const n of [1, 4, 8, 11, 15, 19]) {
    ...
    const path = `/workspaces/sashaslides/presentations/1/screenshots/styled_slide_${String(n).padStart(2, "0")}.png`;
